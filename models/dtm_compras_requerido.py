...
<<<<<<< HEAD
    ...
    #             listOdts = set(odt.split(" "))
    #             # ----------------------------------------------------------------------------------------------------------------------------------------------------
    #             print('listOdts',listOdts,material.codigo)
    ...
    #             # print("listdis",listdis)
    #             if False in listdis:
    #                 listdis.remove(False)
    #             val = {
    #                 "orden_trabajo": odt,
    #                 "disenador": "".join(listdis) if listdis else '',
...
=======
    def get_view(self, view_id=None, view_type='form', **options):
        ...
        return res
>>>>>>> db4db835f1c826d8ea35bb983902265ac3583546
